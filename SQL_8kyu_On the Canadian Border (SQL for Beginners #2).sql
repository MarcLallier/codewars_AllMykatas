/*#_8kyu_#_On the Canadian Border (SQL for Beginners #2)*/
...
--  You know that American, Mexican, and Canadian citizens 
--  don't need visas, so they can just continue their trips. You don't need to check their passports for visas! 
