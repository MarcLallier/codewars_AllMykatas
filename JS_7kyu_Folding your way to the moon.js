/*#_7kyu_#_Folding your way to the moon*/
...
function foldTo(distance) {
  let paperSize = 0.0001
  let paperFold = 0;
   while(paperSize < distance && distance != 0){
      paperSize *= 2
      paperFold ++;
    }
  if (distance <0) {
...
//###___________ou__solution mathematique (des solutions des autres)
